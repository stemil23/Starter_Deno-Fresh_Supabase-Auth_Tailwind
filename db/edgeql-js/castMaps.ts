...
import type * as _pgvector from "./modules/ext/pgvector.ts";
import type * as _ai from "./modules/ext/ai.ts";
...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _pgvector.$vector ? _pgvector.$vector : 
  T extends _ai.$ProviderAPIStyle ? _ai.$ProviderAPIStyle : 
  T extends _ai.$IndexType ? _ai.$IndexType : 
  T extends _ai.$DistanceFunction ? _ai.$DistanceFunction : 
  T extends _ai.$ChatParticipantRole ? _ai.$ChatParticipantRole : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _pgvector.$vector ?
    B extends _pgvector.$vector ?
    B
    :
    never
  :
  A extends _ai.$ProviderAPIStyle ?
    B extends _ai.$ProviderAPIStyle ?
    B
    :
    never
  :
  A extends _ai.$IndexType ?
    B extends _ai.$IndexType ?
    B
    :
    never
  :
  A extends _ai.$DistanceFunction ?
    B extends _ai.$DistanceFunction ?
    B
    :
    never
  :
  A extends _ai.$ChatParticipantRole ?
    B extends _ai.$ChatParticipantRole ?
    B
    :
    never
  :
...
export type literalToScalarType<T extends any> =
  ...
  T extends Float32Array ? scalarWithConstType<_pgvector.$vector, T> :
