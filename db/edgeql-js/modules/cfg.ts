...
export type $AbstractConfigλShape = $.typeutil.flatten<$ConfigObjectλShape & {
  ...
  "<cfg[is ext::pgvector::Config]": $.LinkDesc<_pgvector.$Config, $.Cardinality.AtMostOne, {}, true, false,  false, false>;
  "<cfg[is ext::ai::Config]": $.LinkDesc<_ai.$Config, $.Cardinality.AtMostOne, {}, true, false,  false, false>;
